...
<form name="form_acc_trans_shop" id="form_acc_trans_shop"  enctype="multipart/form-data" class="form-horizontal form-bordered" role="form">
  ...
  <div style="margin: 0px 0px;margin-bottom: 30px;">
    <ons-list-item>
      <div class="center list-pd-r">
    ...
    if ($val->i_type_pay == 2) {
      ...
      if ($val->i_plan_main == 3) {
        ...
        <ons-card style="margin-top: 10px; margin-bottom: 0px;">
          <ons-row>
            <ons-col>
              <ons-list-header>ประเภท <?=$res_planmain->s_topic;?></ons-list-header>
...
//          echo "</pre>";
            ...
            <ons-col>
              ...
              <ons-list-item class="list-item">
                <div class="center list-pd-r list-item__center">
                  <span class="font-16 ">จำนวน</span>
                </div>
                <div class="right list-item__right">
                  <span class="font-16"><?=$val->i_price;?>x<?=$val->i_pax;?> = <?=number_format($val->i_price * $val->i_pax,0);?> <?=$res_planmain->s_unit;?></span>
                </div>
              </ons-list-item>
            </ons-col>
          </ons-row>
  ...
  <input type="hidden" name="taxi_cost" value="<?=number_format($val->i_price * $val->i_pax,0);?>" id="taxi_cost" />
</form>
